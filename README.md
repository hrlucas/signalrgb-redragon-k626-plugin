...
The plugin uses jsDelivr as the default image URL because it usually works better for apps that need the image file directly:
...
GitHub Raw can also be used as an alternative:
